...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://19m368bvt9.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.folderSearchGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['folder'], ['body']);
        
        var folderSearchGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/{folder}/search').expand(apiGateway.core.utils.parseParametersToObject(params, ['folder'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(folderSearchGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.folderSearchOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var folderSearchOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/{folder}/search').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(folderSearchOptionsRequest, authType, additionalParams, config.apiKey);
    };
